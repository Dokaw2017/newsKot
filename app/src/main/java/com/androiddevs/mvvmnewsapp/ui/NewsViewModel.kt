...
class NewsViewModel(
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            ...
            when(t){
                is IOException->searchNews.postValue(Resource.Error("Networ Failure"))
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if (hasinternateConnection()){
                ...
                breakingNews.postValue(Resource.Error("No internate connection"))
            }

        }catch (t:Throwable){
            when(t){
                is IOException->breakingNews.postValue(Resource.Error("Networ Failure"))
                else->breakingNews.postValue(Resource.Error("Conversion Error"))
            }
        }
    }

    private fun hasinternateConnection():Boolean{
